...
Thanks for using glyparse! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/glycoverse/glyparse/issues/new).
...
requests](https://github.com/glycoverse/glyparse/issues) to make sure
