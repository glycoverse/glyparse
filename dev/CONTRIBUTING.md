...
This outlines how to propose a change to glyparse. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glyparse", fork = TRUE)`.
...
Please note that the glyparse project is released with a [Contributor
Code of
Conduct](https://glycoverse.github.io/glyparse/dev/CODE_OF_CONDUCT.md).
